...
import SpeakerDetailPage from './features/public/pages/SpeakerDetailPage'
      ...
      <BrowserRouter>
        <Routes>
          <Route element={<PublicLayout />}>
            ...
            <Route path="symposium/speakers/:id" element={<SpeakerDetailPage />} />
            <Route path="symposium/facilitators" element={<Navigate to="/symposium/speakers" replace />} />
